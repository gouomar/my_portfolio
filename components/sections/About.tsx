  ...
  return (
    <Section id="about" title="About">
      <div className="space-y-6 text-base leading-relaxed text-subtext">
        ...
        <p>
          You&apos;ll see this same systems-first mindset across my solo work, whether managing thread contention in <a href="#codexion" className="font-medium text-text underline decoration-surface-2 underline-offset-4 transition-colors hover:decoration-accent motion-reduce:transition-none">Codexion</a> or chaining AI decisions in <a href="#agency-brain" className="font-medium text-text underline decoration-surface-2 underline-offset-4 transition-colors hover:decoration-accent motion-reduce:transition-none">Agency Brain</a>. I&apos;m currently seeking backend roles where scalable coordination is the core job. Outside of work, you can usually find me swimming, playing League of Legends, or immersed in a good book.
        </p>
      </div>
    </Section>
  );
